<div class="container">
  <div class="card">
    <h5 class="card-header">Saida Estoque</h5>
      ...
      <form method="post">
        ...
        <div class="row">
          ...
          <div class="col-sm">
            ...
            Tipo:
            <input readonly type="text" name="tipo" id="tipo" class="form-control" value="SAIDA" required>
            Armazém:
            ...
            Solicitante:
            <select name="id_solicitante" class="form-control" id="id_solicitante" required>
              <?php foreach($dadosUsuarios as $usuario): ?>
                <option value="" hidden>Selecione um Usuário</option>
        ...
        <div class="form-inline">
          ...
          <div class="input-group mb-2 mr-sm-2">
            <input type="text" size="15px" class="form-control form-control-sm quantidade" id="quantidade">
          </div>
          <div class="input-group mb-2 mr-sm-2">
