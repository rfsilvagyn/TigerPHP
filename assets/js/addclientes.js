window.onload = function () {
  ...
  if (tipoContato == 'EMAIL') {
    ...
    $('#contato').inputmask('(99)9999-9999');
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//ADICAO DA LINHA DE CONTATO
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$(function adicionartelefone(obj) {
  $('#addtelefone').on('click', function () {
    ...
    if (contato !== '') {
      var tr =
        '<tr>' +
        '<td><input readonly style="background-color: transparent; border:0" type="text" name="contatos[tipocontato][]" value="' + tipocontato + '"</td>' +
        '<td><input readonly style="background-color: transparent; border:0; width:300px" type="text" name="contatos[contato][]" value="' + contato + '"</td>' +
        '<td><a class="btn btn-danger btn-sm" href="javascript:;" onclick="excluirTelefone(this)"><i class="fas fa-trash-alt"></i> Excluir</a></td>' +
        '</tr>';

      $('#table_telefones').append(tr);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function excluirTelefone(obj) {
  $(obj).closest('tr').remove();
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//ALTERACAO DA MASCARA DO CAMPO CONTATO QUANDO ALTERAR O CAMPO TIPO
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$("#btn_consulta_cpf").on('click', function () {
  ...
  var settings = {
    "url": "http://dev.itechnology.com.br:5100/consult/cpf",
    "method": "PUT",
    "timeout": 0,
    "headers": {
