...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//CHAMA FUNCAO EXISTE LOGIN VIA AJAX
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function existeLogin(login){
  $.ajax({
    url: BASE_URL+"contratos/existeLogin/"+login,
    type: 'POST',
    data: login,
    dataType: 'json',
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//CHAMA FUNCAO OBTER SENHAS VIA AJAX
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function obterSenhas(id){
  $.ajax({
    url: BASE_URL+"planos/obterSenhas/"+id,
    type: 'POST',
    data: id,
    dataType: 'json',
    success: function(data) {
      $('#senha_autenticacao').val(data.senha_padrao_autenticacao);
      $('#senha_central').val(data.senha_padrao_central);
    }
  });
};
